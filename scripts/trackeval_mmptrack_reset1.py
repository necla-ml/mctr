...
def plot_tracks(exp_dir):   
    ...
    reset_unused = 1 # changed from 3 to 1 as per alex's suggestion
    ...
    if "MMPTracking" in cfg.DATASET.ROOT:
        ...
        cfg.DATASET.ROOT = "/mnt/ml_data/MTMC_Tracking_AIC23_Track1"
...
#    cfg.DATASET.ROOT = "/mnt/ml_data/MMPTracking/"
    ...
    for i, data in enumerate(tqdm(loader)):
        ...
        for v, (target, pred, prev_pred, meta) in enumerate(zip(targetf, predf, prev_predf, metadata_f)):
            ...
            # NOTE: trackeval MOT17 evaluation expects 1-indexed frame_ids
            frame_id = meta["frame_no"] + 1
...
if __name__ == '__main__':
    ...
    # parser.add_argument("FILE", default="PAIRWISE.pth", help="checkpont to load")
